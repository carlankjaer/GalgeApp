...
public class ToSpillereVinderFragment extends Fragment implements View.OnClickListener {
    MediaPlayer player;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_to_spillere_vinder, container, false);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.prøvIgen) {
            ...
            fragmentTransaction1.replace(R.id.frameLayout, new RedigerOrdFragment()).addToBackStack("NULL");
